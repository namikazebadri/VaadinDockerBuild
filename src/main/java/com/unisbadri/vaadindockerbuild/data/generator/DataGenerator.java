package com.unisbadri.vaadindockerbuild.data.generator;

import com.vaadin.flow.spring.annotation.SpringComponent;

import com.unisbadri.vaadindockerbuild.data.service.SamplePersonRepository;
    ...
    public CommandLineRunner loadData(SamplePersonRepository samplePersonRepository) {
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2021, 4, 7, 0, 0, 0));
